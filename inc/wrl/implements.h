...
public:
    HRESULT SetComposableBasePointers(_In_ IUnknown* base, _In_opt_ FactoryInterface* baseFactory = nullptr) throw()
    {
    ...
    ComPtr<IUnknown> GetComposableBase() throw()
    {
...
private:
    ComPtr<IUnknown> composableBase_;
