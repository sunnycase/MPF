...
/*  `triangleafloatist':  An array of triangle area constraints; one float per */
/*    triangle.  Input only.                                                 */
...
/*    floats per hole.  Input only, although the pointer is copied to the     */
...
/*      used (with no number following), `triangleafloatist' must point to a  */
...
/*      initialized.  `triangleafloatist' may be ignored.                     */
...
extern "C" {
	...
	struct triangulateio {
		...
		float *triangleafloatist;                                         /* In only */
